            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">INPUT NOMER KOMUNITAS DI SINI</label>
                  <input type="text" onChang="redy()" id="id" class="form-control" placeholder="Masukkan Nomer Komunitas yang telah terdaftar">
                </div>
              </div>
