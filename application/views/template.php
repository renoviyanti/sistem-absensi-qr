...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-lg"><b>LOOP </b>STATION</span>
      </a>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url()?>template/dist/img/LogoLoop.png" class="user-image" alt="User Image">
                <span class="hidden-xs"> <?=$user->first_name?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?php echo base_url()?>template/dist/img/LogoLoop.png" class="img-circle" alt="User Image">
                  <p>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url()?>template/dist/img/LogoLoop.png" alt="User Image" >
        </div>
      ...
      <ul class="sidebar-menu">
        <li>
          ...
          <a href="<?php echo base_url('komunitas') ?>">
            <i class="fa fa-user"></i> <span>DATA KOMUNITAS</span>
          ...
          <a href="<?php echo base_url('scan1') ?>">
            <i class="fa fa-camera"></i> <span>SCAN QR / PRESENSI</span>

          </a>
          <a href="<?php echo base_url('presensi') ?>">
            <i class="fa fa-list"></i> <span>HASIL PRESENSI</span>
  ...
  <footer class="main-footer">
    ...
    <strong> &copy; 2019 <a href="#">LOOP STATION</a>.</strong> All rights reserved.
  </footer>
